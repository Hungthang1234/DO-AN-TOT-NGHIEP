...
echo.
cd /d "%~dp0.."
"%~dp0..\.venv\Scripts\python.exe" scripts\utils\export_model_info.py
echo.
pause
goto menu
...
:view_guide
cls
if exist "docs\README_QUICKSTART.md" (
    type "docs\README_QUICKSTART.md" | more
) else if exist "docs\MODEL_STORAGE_README.md" (
    type "docs\MODEL_STORAGE_README.md" | more
) else (
